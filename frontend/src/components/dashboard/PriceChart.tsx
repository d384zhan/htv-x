...
export const PriceChart: React.FC<PriceChartProps> = ({ data, ticker }) => {
  ...
  return (
    <div className="bg-gradient-to-b from-[#2e2b2a] to-[#252322] rounded-2xl p-6 shadow-[0_4px_12px_rgba(0,0,0,0.3)] border border-[#3a3736]">
      {/* Header */}
      <h3 className="text-white font-karla font-bold text-lg mb-4">
