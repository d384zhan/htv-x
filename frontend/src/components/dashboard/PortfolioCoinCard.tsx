...
export const PortfolioCoinCard: React.FC<PortfolioCoinCardProps> = ({
  ...
  return (
    <div
      onClick={onClick}
      className={`
        relative rounded-2xl p-6 cursor-pointer m-1.5
    ...
    >
      ...
      <div className="relative flex items-center gap-4">
        {/* Icon */}
        <div className="w-12 h-12 rounded-full bg-gradient-to-b from-[#e8e8e8] to-[#c9c9c9] flex items-center justify-center shadow-md flex-shrink-0">
          {holding.iconUrl ? (
            <Image 
              src={holding.iconUrl} 
              alt={holding.ticker}
            ...
            <span className="text-[#2a2727] font-karla font-bold text-base">
        ...
        <div className="flex flex-col gap-1 min-w-0">
          <span className="text-white font-karla font-bold text-xl">
            {holding.ticker}
          </span>
          <span className="text-gray-400 font-karla text-sm truncate">
            {holding.name}
          </span>
        </div>
      </div>
